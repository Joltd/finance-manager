...
import {DocumentExpenseComponent} from "./document/component/document-expense/document-expense.component";
import {DocumentBrowserComponent} from "./document/component/document-browser/document-browser.component";
import {DocumentIncomeComponent} from "./document/component/document-income/document-income.component";

const routes: Routes = [
  { path: 'document', component: DocumentBrowserComponent },
  { path: 'document/expense/:id', component: DocumentExpenseComponent },
  { path: 'document/income/:id', component: DocumentIncomeComponent },
