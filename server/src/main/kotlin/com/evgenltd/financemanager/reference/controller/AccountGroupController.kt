...
import com.evgenltd.financemanager.reference.service.AccountGroupService
...
class AccountGroupController(
    ...
    fun update(@RequestBody record: AccountGroupRecord) = accountGroupService.update(record)
