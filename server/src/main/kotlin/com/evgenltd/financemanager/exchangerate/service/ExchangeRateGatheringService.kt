...
class ExchangeRateGatheringService(
    ...
    @Async
    fun updateActual() {
        lockService.withTryLock(ExchangeRate::class.simpleName!!) {
    ...
    @Async
    fun updateHistory(date: LocalDate, currencies: List<String> = emptyList()) {
        lockService.withTryLock("${ExchangeRateHistory::class.simpleName}:$date") {
